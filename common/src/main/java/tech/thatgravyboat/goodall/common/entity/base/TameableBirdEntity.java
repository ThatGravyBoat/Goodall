...
public abstract class TameableBirdEntity extends TamableAnimal implements FlyingAnimal {
    ...
    protected TameableBirdEntity(EntityType<? extends TamableAnimal> entityType, Level level) {
